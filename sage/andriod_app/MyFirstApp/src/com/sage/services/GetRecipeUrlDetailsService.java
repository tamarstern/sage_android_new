...
public class GetRecipeUrlDetailsService extends BaseService {

	private String token;
	private String userName;
	private String url;

	public GetRecipeUrlDetailsService(String url, String token, String userName) {
		super(null);
		this.token = token;
	...
	private static final String GET_RECIPIES_FOR_USER = ServicesConstants.APP_SERVER_URL + "/api/getUrlDisplayData/";

	public JsonElement getUrlDetails() throws Exception {
	...
	protected void addHeaderProperties(HttpURLConnection conn) {
		...
		conn.setRequestProperty("url", url);
