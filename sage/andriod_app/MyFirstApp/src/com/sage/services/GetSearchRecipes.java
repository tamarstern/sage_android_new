...
public class GetSearchRecipes extends BaseService {
	private String token;
	private String userName;
	private String recipText;
	private int pageNumber;
	
	public GetSearchRecipes(String token, String userName, String recipText, int pageNumber){
		super(null);
		this.token = token;
	...
	private static final String GET_RECIPIES_FOR_USER = ServicesConstants.APP_SERVER_URL + "/api/searchRecipes/";
