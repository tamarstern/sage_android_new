...
public class GetNewsFeedRecipesForUser extends BaseService {
	private String token;
	private String userName;
	private int pageNumber;
	
	public GetNewsFeedRecipesForUser(String token, String userName, int pageNumber){
		super(null);
		this.token = token;
	...
	private static final String GET_RECIPIES_FOR_USER = ServicesConstants.APP_SERVER_URL + "/api/newsFeedRecipies/";
	...
	protected void addHeaderProperties(HttpURLConnection conn) {
		...
		conn.setRequestProperty(ServicesConstants.PAGE_NUMBER, String.valueOf(pageNumber));
	}
