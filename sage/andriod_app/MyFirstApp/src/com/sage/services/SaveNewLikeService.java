...
public class SaveNewLikeService extends BaseService {

	private static final String SAVE_NEW_COMMENT_URL = ServicesConstants.APP_SERVER_URL + "/api/recipesPerUser/like/";
	...
	public SaveNewLikeService(String recipeId, String token, String username,boolean featuredRecipe, Activity activity) {
		super(activity);
		this.token = token;
	...
	public JsonElement saveLike() throws Exception {
