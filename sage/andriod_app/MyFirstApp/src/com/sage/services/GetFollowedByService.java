...
public class GetFollowedByService extends BaseService {

	private String token;
	private String userName;
	private int pageNumber;

	public GetFollowedByService(String token, String userName, int pageNumber) {
		super(null);
		this.token = token;
	...
	private static final String GET_FOLLOWING = ServicesConstants.APP_SERVER_URL + "/api//profile/getFollowedBy";
