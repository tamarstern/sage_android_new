...
public class GetPublishedRecipesForUser extends BaseService {
	...
	public GetPublishedRecipesForUser(String token, String userName, String recipeAuthor, int pageNumber) {
		super(null);
		this.token = token;
	...
	protected void addHeaderProperties(HttpURLConnection conn) {
		...
		conn.setRequestProperty("recipeauthor", recipeAuthor);
