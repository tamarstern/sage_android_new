...
public class ActivityConstants {
	...
	public static final String USER_DISPLAY_ELEMENT_NAME = "userDisplayName";
	public static final String TOKEN_ELEMENT_NAME = "token";
	public static final String SUCCESS_ELEMENT_NAME = "success";
	public static final String IS_FOLLOWING = "isFollowing";
	public static final String FOLLOEWD_BY_COUNT = "followed_by_count";
	...
	public static final String SIGNED_TERMS = "signedTerms";
